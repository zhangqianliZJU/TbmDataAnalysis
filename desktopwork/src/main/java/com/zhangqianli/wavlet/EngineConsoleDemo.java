...
public class EngineConsoleDemo {
	public static void main(String args[]) {
		try {
			...
			/*
			 * Find elements greater than 5 1. Create input matrix 2. Put variable matrix in
			 * the MATLAB base workspace 3. Solve A(A>5) in MATLAB 4. Return results and
			 * display 5. Call the power function in MATLAB on the returned matrix 6.
			 * Display results
			 */
