 ...
 */
public class DynamicBirch3 extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/tbminer/TBMiner4.fxml"));
            primaryStage.setTitle("TBMiner");
            Scene tbminer = new Scene(root);
            tbminer.getStylesheets().add("/tbminer/Chart1.css");
